...
def var_author():
    ...
    mlaku('%s║     • %sABDULLAH DADA'%(O,P))
    mlaku('%s║     • %sSHAHZAIN DAVID JOIYA'%(O,P))
    mlaku('%s║'%(O))
...
def start_methodezz():
    ...
    print('%s╠══[%s3%s] %sVery Slow Crack %s[%s18 pass%s]'%(O,P,O,P,O,P,O))
